    ...
    return (
        <div
            ...
            className={cn(
                ...
                "hover:border-[#93C5FD] transition-colors duration-150",
...
function CardTitle({ className, ...props }) {
    return (
        <div
            ...
            className={cn(
                "font-heading text-base leading-snug font-semibold text-[#1E3A8A]",
...
function CardDescription({ className, ...props }) {
    return (
        <div
            ...
            className={cn("text-sm text-[#3B5BA5]", className)}
            {...props}
        />
    );
}
...
function CardFooter({ className, ...props }) {
    return (
        <div
            ...
            className={cn(
                "flex items-center rounded-b-xl border-t border-[#BFDBFE] bg-[#EFF6FF] p-(--card-spacing)",
                className
            )}
            {...props}
        />
