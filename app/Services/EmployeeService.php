...
class EmployeeService
{
    ...
    public function find(int $id): array
    {
        ...
        return [
            ...
            'employeeEarnings'  => $employee->employeeEarnings,  // ← expose to controller
        ];
    }
    ...
    public function create(array $data)
    {
        ...
        // ── Employee Earnings ─────────────────────────────────────────────────
        if (!empty($data['employee_earnings'])) {
    ...
    public function update(Employee $employee, array $data)
    {
        ...
        // ── Employee Earnings — delete-and-recreate (handles add/remove/edit) ─
    ...
    private function employeeEarningData(array $entry): array
    {
        return [
